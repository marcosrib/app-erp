...
public interface ChartAccountApi {
    ...
    List<ChartAccountResponse> index();
    ...
    void create(@RequestBody ChartAccountRequest chartAccountRequest);
    @Operation(summary = "Atualiza plano de contas")
    @ApiResponses(value = {
    ...
    void update(@RequestBody ChartAccountRequest chartAccountRequest, @Parameter(description = "Id chart account")  @PathVariable Integer id);
}
