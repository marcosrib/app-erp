...
CREATE TABLE IF NOT EXISTS "CHART_ACCOUNTS_GROUP" (
  "ID" SERIAL PRIMARY KEY,
  "NAME" VARCHAR(150),
  "CREATED_AT" TIMESTAMP,
  "UPDATED_AT" TIMESTAMP
...
CREATE TABLE IF NOT EXISTS "CHART_ACCOUNTS" (
  ...
  "TYPE" VARCHAR(50),
  "NAME" VARCHAR(150),
  "CHART_ACCOUNTS_GROUP_ID" INTEGER,
  "CREATED_AT" TIMESTAMP,
  "UPDATED_AT" TIMESTAMP,
  CONSTRAINT "FK_CHART_ACCOUNTS_CHART_ACCOUNTS_GROUP"
    FOREIGN KEY ("CHART_ACCOUNTS_GROUP_ID")
    REFERENCES "CHART_ACCOUNTS_GROUP" ("ID")
);
...
CREATE TABLE IF NOT EXISTS "ACCOUNTS_PAYABLE" (
  ...
  CONSTRAINT "FK_ACCOUNTS_PAYABLE_COST_CENTER_ID"
    FOREIGN KEY ("COST_CENTER_ID")
    REFERENCES "COST_CENTERS" ("ID"),
  CONSTRAINT "FK_ACCOUNTS_PAYABLE_CHART_ACCOUNT_ID"
    FOREIGN KEY ("CHART_ACCOUNT_ID")
    REFERENCES "CHART_ACCOUNTS" ("ID")
);
